    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1><a href="#" style="color:#DD3333;">Hobo Hydrauliek</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
          ...
          <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
            <img src="{{ asset('img/uploads/default-avatar.jpg') }}" alt="" style="margin: 0 auto;border-radius: 50%;width:150px;height:150px;object-fit:cover;vertical-align:middle;display: block;">
          </td>
	      </tr><!-- end tr -->
				<tr>
