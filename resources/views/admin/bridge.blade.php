...
<div class="mt-1 mb-5 button-container">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('admin/post-add-bridge') }}" method="POST" class="mt-2">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input type="adress" class="form-control" id="adress" name="adress" placeholder="e.g. Grote Markt, Groningen">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="bridgeHash" name="bridgeHash" placeholder="1KIJO0JE">
                </div>
